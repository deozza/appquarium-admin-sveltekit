<script lang="ts">
	...
	import AnimalBehaviourForm from '../../../../components/molecules/species/animalBehaviourForm/AnimalBehaviourForm.svelte';
	...
	import AquariumConstraintsForm from '../../../../components/molecules/species/aquariumConstraintsForm/AquariumConstraintsForm.svelte';
...
<div class="flex-c space-y-6">
	...
	{:else}
		...
		<section class="w-3/5 flex-c space-y-6 p-6 bg-white border-2 rounded-md border-black">
			...
			<GeneralForm species={fish} speciesOrigins={$origins} {user} />
		</section>
		...
		<section class="w-3/5 flex-c space-y-6 p-6 bg-white border-2 rounded-md border-black">
			...
			<NamingForm
				species={fish}
				speciesFamilies={$fishFamilies}
				speciesGenres={$fishGenres}
				{user}
			/>
		</section>
		...
		<section class="w-3/5 flex-c space-y-6 p-6 bg-white border-2 rounded-md border-black">
			<PublicationStateSwitcher species={fish} {user} />
		</section>
	{/if}
</div>
