<script lang="ts" context="module">
    ...
    export async function load(){
        ...
        const speciesGenres: Result = await invertebrateUseCase.getInvertebrateGenres(cookie.content)
        ...
        const speciesFamilies: Result = await invertebrateUseCase.getInvertebrateFamilies(cookie.content)
...
<script lang="ts">
    import {header} from "../../../../components/pages/admin/invertebrate/add/Modeles";
