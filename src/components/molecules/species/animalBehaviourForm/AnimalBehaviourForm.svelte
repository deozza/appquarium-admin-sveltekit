            ...
            <div class="flex-r ">
                ...
                <div class='flex-r' style="flex: 2">
                    ...
                    <label class='w-1/2 px-3 ' for='diurnalFalse'>
                        <input class="" type="radio" bind:group={species.animal_behaviour.diurnal} value={false} id="diurnalFalse" name="diurnalFalse">
                        La nuit
                    </label>
                </div>
            </div>
                ...
                <div class='flex-r' style="flex: 2">
                    {#each $animalZones as zone}
                        <label class='px-1' for={zone.name}>
                            <input class="" type="checkbox" bind:group={species.animal_behaviour.zone} value={zone.name} id={zone.name} name={zone.name}>
                            {zone.name}
                        </label>
                    {/each}
                </div>
                ...
                <div class='flex-r' style="flex: 2">
                    {#each $alimentations as alimentation}
                        <label class='px-1' for={alimentation.name}>
                            <input class="" type="checkbox" bind:group={species.animal_behaviour.alimentation} value={alimentation.name} id={alimentation.name} name={alimentation.name}>
                            {alimentation.name}
                        </label>
                    {/each}
                </div>
