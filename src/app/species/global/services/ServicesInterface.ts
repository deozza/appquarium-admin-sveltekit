...
export default interface ServicesInterface {
	...
	createAnimalBehaviour(
		jwt: string,
		animalBehaviour: AnimalBehaviour
	): Promise<string | Array<UseCaseError>>;

	addAnimalBehaviourToSpecies(
		jwt: string,
		animalBehaviour: AnimalBehaviour
