export default class AnimalSpecs {
	...
	constructor(animalSpecs: Array<string>) {
		...
		this.longevity_in_years = animalSpecs.hasOwnProperty('longevity_in_years')
			? animalSpecs['longevity_in_years']
			: 0;
		this.species_uuid = animalSpecs.hasOwnProperty('species_uuid')
			? animalSpecs['species_uuid']
			: '';
	}
}
