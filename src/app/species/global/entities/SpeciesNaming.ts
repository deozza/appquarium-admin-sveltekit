...
export default class SpeciesNaming {
	...
	constructor(speciesNaming: Array<string>) {
		...
		this.common_names = speciesNaming.hasOwnProperty('common_names')
			? speciesNaming['common_names']
			: [];
		...
		this.species_family =
			speciesNaming.hasOwnProperty('species_family') && speciesNaming['species_family'] !== null
				? new SpeciesFamily(speciesNaming['species_family'])
				: new SpeciesFamily([]);
		this.species_genre =
			speciesNaming.hasOwnProperty('species_genre') && speciesNaming['species_genre'] !== null
				? new SpeciesGenre(speciesNaming['species_genre'])
				: new SpeciesGenre([]);
		this.species_uid = speciesNaming.hasOwnProperty('species_uid')
			? speciesNaming['species_uid']
			: '';
	}
}
