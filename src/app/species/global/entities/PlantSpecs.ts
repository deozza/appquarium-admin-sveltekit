export default class PlantSpecs {
	...
	constructor(plantSpecs: Array<string>) {
		...
		this.need_in_fertilizer = plantSpecs.hasOwnProperty('need_in_fertilizer')
			? plantSpecs['need_in_fertilizer']
			: false;
		this.growth_speed = plantSpecs.hasOwnProperty('growth_speed') ? plantSpecs['growth_speed'] : '';
		this.need_in_carbone = plantSpecs.hasOwnProperty('need_in_carbone')
			? plantSpecs['need_in_carbone']
			: false;
	}
}
