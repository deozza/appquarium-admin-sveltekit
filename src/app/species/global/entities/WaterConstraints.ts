export default class WaterConstraints {
	...
	constructor(waterConstraints: Array<string>) {
		...
		this.created_at = waterConstraints.hasOwnProperty('created_at')
			? waterConstraints['created_at']
			: '';
		this.updated_at = waterConstraints.hasOwnProperty('updated_at')
			? waterConstraints['updated_at']
			: '';
		...
		this.species_uuid = waterConstraints.hasOwnProperty('species_uuid')
			? waterConstraints['species_uuid']
			: '';
	}
}
